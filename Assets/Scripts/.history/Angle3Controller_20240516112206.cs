...
public class Angle3Controller : MonoBehaviour
{
    ...
    void HandleClick(Vector3 worldTouchPosition)
    {
        ...
        {
            // 点击阳台门 ： 打开阳台
            if (doorToBalcony.activeSelf && doorToBalcony.GetComponent<PolygonCollider>().bounds.Contains(worldTouchPosition))
            {
            ...
            // 点击衣服，获取衣服
            if (clothes.activeSelf && clothes.GetComponent<PolygonCollider>().bounds.Contains())
            // 点击阳台门，关闭
