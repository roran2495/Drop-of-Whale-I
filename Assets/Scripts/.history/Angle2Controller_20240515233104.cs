    ...
    void HandleClick(Vector3 worldTouchPosition)
    {
        ...
        else 
        {
            ...
            if(picture0.activeSelf && !picture0.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition))
            {
                ...
                EnableOtherColliders(picture0);
            }
            // 当前说明书特写 点击说明书外退出特写 说明书1-5c
            else if(instructions0.activeSelf && !instructions0.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition)
