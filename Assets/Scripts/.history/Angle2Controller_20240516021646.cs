        ...
        else 
        {
            ...
            else if(box0.activeSelf)
            {
                ...
                if (!box0.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition)
                    && (!box1.activeSelf && !box2.activeSelf 
                    || box1.activeSelf && !box2.activeSelf && !box1.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition)
                    || box1.activeSelf && box2.activeSelf && !box)) 
                {
