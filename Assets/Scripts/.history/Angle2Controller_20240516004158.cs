...
public class Angle2Controller : MonoBehaviour
{
            ...
            else 
            {
                ...
                else 
                {
                    ...
                    else if (cabinet4Box.activeSelf && cabinet4Box.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition))
                    {
                        ...
                        if(!flagCabinet4)
                        {
                            Sprite newSprite = Resources.Load<Sprite>("others/angle2-9-(2)");
                            cabinet7Content.GetComponent<SpriteRenderer>().sprite = newSprite; 
                            flagCabinet7 = true;
                        } 
                        else
                        {
    ...
    {
        password1.GetComponent<PolygonCllider2D>().enabled = true;
        password2.GetComponent<PolygonCllider2D>().enabled = true;
        password3.GetComponent<PolygonCllider2D>().enabled = true;
        password4.GetComponent<PolygonCllider2D>().enabled = true;
        open.GetComponent<PolygonCllider2D>().enabled = true;
    }
