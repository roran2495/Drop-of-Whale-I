...
public class Angle2Controller : MonoBehaviour
{
    ...
    private Angle1Controller angle1ControllerInstance;
    ...
    void Start()
    {
        ...
        SetFlag();
        angle1ControllerInstance = new Angle1Controller();
        // 判断是否处于黑暗中
        darkness.SetActive(angle1ControllerInstance.flagCurtain && angle1ControllerInstance.flagSwitcher);
    }
