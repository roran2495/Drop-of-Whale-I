...
public class Angle8Controller : MonoBehaviour
{
    ...
    void ExchangeBooks()
    {
        ...
        GameObject place3 = this.transform.Find("book3").gameObject;
        GameObject place23 = this.transform.Find("book2 3").gameObject;
        GameObject place4 = this.transform.Find("book4").gameObject;
        GameObject place4l = this.transform.Find("book4 left").gameObject;
        GameObject place4r = this.transform.Find("book4 right").gameObject;
        GameObject place6 = this.transform.Find("book6").gameObject;
        GameObject place7 = this.transform.Find("book7").gameObject;
        GameObject place8 = this.transform.Find("book8").gameObject;
        GameObject place9 = this.transform.Find("book9").gameObject;
        GameObject place79 = this.transform.Find("book79").gameObject;
        GameObject place10 = this.transform.Find("book10").gameObject; 
    }
