    ...
    void HandleClick(Vector3 worldTouchPosition)
    {
        ...
        else 
        {
            ...
            else if(box0.activeSelf)
            {
                ...
                {
                    Debug.Log("close letters");
                    box2.SetActive(false);
                    box1.GetComponent<PolygonCollider2D>().enabled = true;
                    close.GetComponent<PolygonCollider2D>().enabled = true;
                ...
                {
                    box2.SetActive(true);
                    box1.GetComponent<PolygonCollider2D>().enabled = false;
