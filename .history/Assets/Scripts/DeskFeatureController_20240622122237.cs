    ...
    void Update()
    {
        ...
        if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Ended || Input.GetMouseButtonUp(0))
        {
            ...
            if (cup1.activeSelf && cup1.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition))
            {
                ...
                cupColer.GetComponent<SpriteRenderer>().color = new Color(180, 101, 174, 255);
            ...
            if (glassRod2.activeSelf && glassRod2.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition))
            {
