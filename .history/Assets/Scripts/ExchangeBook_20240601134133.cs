                        ...
                        if (!bigBooks.Contains(selected[2]))
                        {
                            ...
                            if (selected[0] == "23")
                            {
                                if (selected[1] == "4l" && selected[2] == "4r" || selected[1] == "4r" && selected[2] == "4l"
                                    || selected[1] == "7" && selected[2] == "9" || selected[1] == "9" && selected[2] == "7")
                                    flag = true;
                            }
                            if (selected[0] == "4")
                            {
                            ...
                            {
                                if (selected[1] == "4l" && selected[2] == "4r" || selected[1] == "4r" && selected[2] == "4l"
                                    || selected[1] == "2" && selected[2] == "3" || selected[1] == "3" && selected[2] == "2")
                                    flag = true;
                            }
                            ...
                            if (flag)
                            {
                                ...
                                if (mappings.TryGetValue(selected[0], out pair0) && mappings.TryGetValue(selected[1], out pair1) && mappings.TryGetValue(selected[2], out pair2))
                                {
                                    int intValue1 = pair1.value;
                                    pair1.obj.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("angle8/angle8-9-(" + pair2.value + ")-(" + selected[1] + ")");
                                    pair1.value = pair2.value;
                                    pair2.obj.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("angle8/angle8-9-(" + intValue1 + ")-(" + selected[2] + ")");
                                    pair2.value = intValue1;
