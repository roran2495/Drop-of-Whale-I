...
{
    public static GameObject itemPrefab; // 预制体
    private staticGameObject preSelectedGameObject;
    private DisplayInventory  displayInventory = new DisplayInventory();Item preSelectedItem;
