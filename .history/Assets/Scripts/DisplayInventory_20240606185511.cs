...
public class DisplayInventory : MonoBehaviour
{
    ...
    private void AddClickHandler(GameObject newItem, Item item)
    {
        ...
        SpriteRenderer spriteRenderer = newItem.transform.Find("object").gameObject.GetComponent<SpriteRenderer>();
        ...
        // 添加 PointerUp Entry 到 EventTrigger
        trigger.triggers.Add(pointerUpEntry);

        // 如果是移动平台，添加 PointerClick Entry
        if (Application.platform == RuntimePlatform.Android || Application.platform == RuntimePlatform.IPhonePlayer)
        {
            ...
            // 添加 PointerClick Entry 到 EventTrigger
