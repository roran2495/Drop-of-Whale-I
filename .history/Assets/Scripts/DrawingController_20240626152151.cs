...
public class DrawingController : MonoBehaviour
{
    ...
    private bool firstDrawing = false;
    ...
    {
        yield return new WaitForSeconds(delayInSeconds); // 等待指定的时间

        targetObject.SetActive(true); // 激活目标游戏对象
    }
}
