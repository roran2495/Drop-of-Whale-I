...
public class DisplayInventory : MonoBehaviour
{
        ...
        else if (preSelectedItem != null && featuresId.Contains(preSelectedItem.id))
        {
            ...
            if (item.isSelected) // 选择
            {
                ...
                if (preSelectedItem.id == "02" && item.id == "16")
                {
                    ...
                    GlobalManager.AddItem("21", Resources.Load<Sprite>("others/broom handle 1"));
                ...
                else if (preSelectedItem.id == "15" && item.id == "22")
                {
    ...
    void Resolve19(GameObject gameObject)
    {
