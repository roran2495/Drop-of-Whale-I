...
public class DeskFeatureController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        rgb1 = pigmentsFeature.transform.Find("Canvas1").Find("rgb1").GetComponent<TMP_InputField>();
        rgb2 = pigmentsFeature.transform.Find("Canvas2").Find("rgb2").GetComponent<TMP_InputField>();
        rgb3 = pigmentsFeature.transform.Find("Canvas3").Find("rgb3").GetComponent<TMP_InputField>();
