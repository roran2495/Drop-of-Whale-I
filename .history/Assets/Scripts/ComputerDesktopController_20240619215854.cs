    ...
    void Update()
    {
        ...
        if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Ended || Input.GetMouseButtonUp(0))
        {
            ...
            if (desktopIconTxt.activeSelf && desktopIconTxt.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition))
            {
                ...
                {
                    txtIcon.transform.position = new Vector3(-5.583002f, txtIcon.transform.position.y, txtIcon.transform.position.z);
                }
                else
                {
                    txtIcon.transform.position = new Vector3(-6.18f, txtIcon.transform.position.y, txtIcon.transform.position.z);
                }
            }
            // 关闭txt
            ...
            {
                emailIcon.transform.position = new Vector3(-6.18f, emailIcon.transform.position.y, emailIcon.transform.position.z);
            }
            // txt密码提交
            ...
            if (desktopIconEmail.activeSelf && desktopIconEmail.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition))
            {
                ...
                {
                    emailIcon.transform.position = new Vector3(-5.583002f, emailIcon.transform.position.y, emailIcon.transform.position.z);
                }
                else
                {
                    emailIcon.transform.position = new Vector3(-6.18f, emailIcon.transform.position.y, emailIcon.transform.position.z);
            ...
            {
                emailContentContent.GetComponent<SpriteRenderer>().sprite = emailContentContent.GetComponent<Image>().sprite = Resources.Load<Sprite>("angle7/angle7-10-(6)-(4)");
                emailInput.SetActive(false);
            ...
            if (txtIcon.activeSelf && !emailIcon.activeSelf)
            {
                txtIcon.transform.position = new Vector3(-6.18f, emailIcon.transform.position.y, emailIcon.transform.position.z);
            }
            // email登录
