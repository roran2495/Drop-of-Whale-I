...
public class ExchangeBook : MonoBehaviour
{
    ...
    private int flagPlace2, flagPlace3, flagPlace23, flagPlace4, flagPlace4l, flagPlace4r, flagPlace6, flagPlace7, flagPlace8, flagPlace9, flagPlace79, flag 
    ...
    {
        Sprite sprite1 = gameObject1.GetComponent<SpriteRenderer>().sprite;
        gameObject1.GetComponent<SpriteRenderer>().sprite = gameObject2.G
