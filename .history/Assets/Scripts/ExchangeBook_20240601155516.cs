...
public class ExchangeBook : MonoBehaviour
{
                ...
                if (!Camera.main.transform.Find("darkness").gameObject.activeSelf)
                {
                    ...
                    if (selected.Count == 3)
                    {
                        ...
                        if (!bigBooks.Contains(selected[2]))
                        {
                            ...
                            if (bigBook != "")
                            {
                                ExchangeBook(bigBook, selected[0]);
                    ...
                    else if (selected.Count == 2)
                    {
                        ...
                        if (!bigBooks.Contains(selected[0]) && !bigBooks.Contains(selected[1]))
                        {
                            ...
                            {
                                Debug.Log("交换："+pair0.value+"   "+pair1.value);
    ...
    void ExchangeBook(string book1, string book2)
    {
    ...
    void FindAndToggleActive(string str)
    {
        switch (str)
        {
            ...
            case "3": place2.SetActive(!place2.activeSelf); break;
            case "23": place2.SetActive(!place2.activeSelf); break;
            case "4": place2.SetActive(!place2.activeSelf); break;
            case "4l": place2.SetActive(!place2.activeSelf); break;
            case "4r": place2.SetActive(!place2.activeSelf); break;
            case "6": place2.SetActive(!place2.activeSelf); break;
            case "7": place2.SetActive(!place2.activeSelf); break;
            case "8": place2.SetActive(!place2.activeSelf); break;
            case "9": place2.SetActive(!place2.activeSelf); break;
            case "79": place2.SetActive(!place2.activeSelf); break;
            case "10": place2.SetActive(!place2.activeSelf); break;
        }
    }
    // 更新 flagPlace 变量的值
