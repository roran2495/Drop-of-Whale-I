...
public class DisplayInventory : MonoBehaviour
{
    ...
    public void ShowObject()
    {
        ...
        foreach (var item in GlobalManager.items)
        {
            ...
            if (item.isSelected)
                newItem.transform.Find("object").gameObject.GetComponent<SpriteRenderer>().color = new Color(0.9f, 0.9f, 0.9f); 
            else
                newItem.transform.Find("object").gameObject.GetComponent<SpriteRenderer>().color = new Color(1f, 0.9f, 0.9f); 
            // 添加点击事件监听器
