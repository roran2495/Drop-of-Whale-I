    ...
    void Update()
    {
        if (flagResolve22)
        {
            ...
            if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Ended || Input.GetMouseButtonUp(0))
            {
                ...
                GameObject F19 = feature.transform.Find("19").
                GameObject open = feature.transform.Find("19").Find("open").gameObject;
                GameObject get = feature.transform.Find("19").Find("get").gameObject;
                GameObject useMatch = feature.transform.Find("19").Find("use match").gameObject;
                ...
                else if (useMatch.activeSelf && useMatch.GetComponent<Collider2D>().bounds.Contains(worldTouchPosition))
                {
