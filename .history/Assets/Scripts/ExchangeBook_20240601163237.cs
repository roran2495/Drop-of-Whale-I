...
public class ExchangeBook : MonoBehaviour
{
    ...
    void ExchangeBooks(string book1, string book2, bool flag)
    {
        ...
        // 更新显示书
        bookNum1 = bookNum1==2? 3 : bookNum1;
        bookNum2 = bookNum1==2? 3 : bookNum1;
        Debug.Log("angle8/angle8-9-(" + bookNum1 + ")-(" + book1 + ")");
        Debug.Log("angle8/angle8-9-(" + bookNum2 + ")-(" + book2 + ")");
        bookPlace1.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("angle8/angle8-9-(" + bookNum1 + ")-(" + book1 + ")");
        bookPlace1.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("angle8/angle8-9-(" + bookNum2 + ")-(" + book2 + ")");
