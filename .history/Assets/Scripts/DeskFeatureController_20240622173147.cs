...
public class DeskFeatureController : MonoBehaviour
{
    ...
    private bool flagP;
    private bool flagW;
    private Color[] colorsPigments = {new Color(157, 41, 51),new Color(231, 213, 160),new Color(5, 119, 72),new Color(220, 48, 35),new Color(186, 44, 192) };
                    ...
                    if (!flagM11)
                    {
                        foreach(Transform child in cupColer.transform)
                        {
                            if (!child.gameObject.activeSelf)
                            {
                                ...
                                Debug.Log(child.GetComponent<REN);
