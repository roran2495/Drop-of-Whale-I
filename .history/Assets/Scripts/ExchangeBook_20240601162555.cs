...
public class ExchangeBook : MonoBehaviour
{
    ...
    void ExchangeBooks(string book1, string book2, bool flag)
    {
        ...
        // 2. flag = true. book1对应合成的大书，book2对应待取出的大书。此时book1被使用，放入book2的书，book2被弃用
        // 3. flag = true. book1对应被拆分的小书之一，book2对应被选中，待被放入book1的书
        ...
        UpdateBookNum(book1, flag? 0 : bookNum2);
        UpdateBookNum(book2, bookNum1);
