...
public class ComputerDesktopController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Ended || Input.GetMouseButtonUp(0))
        {
            ...
            {
                if (inputFieldEmailAccount.text == "STP93514@myemail.com" && inputFieldEmailPassword.text == "Nn0514")
                {
                    flagEmail = true;
    ...
    {
        string txtTmp = inputFieldEmailAccount.text + 
        inputFieldEmailAccount.text = "@myemail.com";
    }
}
