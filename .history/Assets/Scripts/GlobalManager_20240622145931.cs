...
public class Item {
    ...
    public Item(string id, Sprite sprite, Color color, int ) 
    {
        this.id = id;
        this.sprite = sprite;
        this.color = color;
...
public static class GlobalManager {
    ...
    {
        items.Add(new Item(id, sprite, Color.white));
        OnItemsChanged?.Invoke();
    }
    public static void AddItemColor(string id, Color color)
    {
        items.Add(new Item(id, null, color));
        OnItemsChanged?.Invoke();
    }
    public static void AddItemCup(string id, Color color)
    {
        items.Add(new Item(id, null, color));
        OnItemsChanged?.Invoke();
    }
