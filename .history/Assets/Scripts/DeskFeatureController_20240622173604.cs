...
public class DeskFeatureController : MonoBehaviour
{
    ...
    private bool flagP;
    private bool flagW;
    private Color[] colorsPigments = {new Color(157f/255f, 41f/255f, 51f/255f),new Color(231/255f, 213/255f, 160/255f),new Color(5/355, 119, 72),new Color(220, 48, 35),new Color(186, 44, 192) };
