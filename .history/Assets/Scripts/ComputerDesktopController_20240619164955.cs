...
public class ComputerDesktopController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        txtInputClose = txt.transform.Find("input").transform.Find("close").gameObject;
        txtInputInput = txt.transform.Find("input").transform.Find("input").gameObject;
        txtInputSubmit = txt.transform.Find("input").transform.Find("submit").gameObject;
        txtContentClose = txt.transform.Find("Input").transform.Find("close").gameObject;
