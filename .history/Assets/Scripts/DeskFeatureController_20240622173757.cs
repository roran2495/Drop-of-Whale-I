...
public class DeskFeatureController : MonoBehaviour
{
    ...
    {
        pigmentsFeature.transform.Find("color").GetComponent<SpriteRenderer>().color = new Color(float.Parse(rgb1.text)/255f, float.Parse(rgb2.text), float.Parse(rgb3.text)); 
    }
}
