...
public class ExchangeBook : MonoBehaviour
{
    ...
    void ExchangeBooks(string book1, string book2, bool flag)
    {
        ...
        bookPlace1.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("angle8/angle8-8-(" + bookNum1 + ")-(" + book1 + ")");
        bookPlace1.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("angle8/angle8-8-(" + bookNum2 + ")-(" + book2 + ")");
