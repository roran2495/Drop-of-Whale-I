...
public class DeskFeatureController : MonoBehaviour
{
    ...
    private bool flagP;
    private bool flagW;
    private Color[] colorsPigments = {new Color(157f/255f, 41f/255f, 51f/255f),new Color(231/255f, 213/255f, 160/255f),new Color(5f/255f, 119f/255f, 72f/255f),new Color(220f/255f, 48f/255f, 35f/255f),new Color(186f/255f, 44f/255f, 192) };
    ...
    void Update()
    {
        ...
        if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Ended || Input.GetMouseButtonUp(0))
        {
            ...
            if (cup1.activeSelf && cup1.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition))
            {
                ...
                SetColor(new Color(180, 201, 174));
                SetColorFalse();
