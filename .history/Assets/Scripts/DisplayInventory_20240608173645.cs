...
public class DisplayInventory : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // 实现移动
        if (F22.activeSelf && Vector2.Distance(F22.transform.localPosition, targetPosition) > 0.1f)
        {
            Debug.Log(Vector2.Distance(F22.transform.localPosition, targetPosition) > 0.1f);
