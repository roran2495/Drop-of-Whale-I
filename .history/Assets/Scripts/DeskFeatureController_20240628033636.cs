            ...
            else
            {
                ...
                else if (eggFeature.activeSelf)
                {
                    if (egg.activeSelf && egg.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition))
                    {
                        ...
                        {
                            SetWord(1, "我还是先把现在的这个鸡蛋处理完再加新的蛋吧");
                        }
                        else
                        {
                ...
                else if (cup2.activeSelf)
                {
                    ...
                    else
                    {
                        if (egg.activeSelf && egg.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition))
                        {
                            ...
                            {
                                SetWord(1, "蛋胚不好处理, 我还是处理一个鸡蛋再考虑放下一个吧");
                            }
                        }
                        ...
                        else if (glassRod1.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition))
                        {
                            ...
                            {
                                SetWord(1, "还有材料没有加入不用进行搅拌");
                            }
                            else if (eggEgg6.activeSelf || eggEgg7.activeSelf)
                            {
                                SetWord(1, "鸡蛋还没有没有处理好呢");
                            }
                            else
                            {
