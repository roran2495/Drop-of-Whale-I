...
public class ExchangeBook : MonoBehaviour
{
    ...
    void ExchangeBooks(string book1, string book2, bool flag)
    {
        ...
        UpdateBookNum(book1, flag? 0 : bookNum1);
        UpdateBookNum(book2, bookNum2);
    ...
    void UpdateBookNum(string str, int num)
    {
        switch (str)
        {
            ...
            case "3": flagPlace2 = num;break;
            case "23": flagPlace2 = num;break;
            case "4": flagPlace2 = num;break;
            case "4l": flagPlace2 = num;break;
            case "4r": flagPlace2 = num;break;;
            case "6": flagPlace2 = num;break;
            case "7": flagPlace2 = num;break;
            case "8": flagPlace2 = num;break;
            case "9": flagPlace2 = num;break;
            case "79": flagPlace2 = num;break;
            case "10": flagPlace2 = num;break;
        }
    }
