...
public class DeskFeatureController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Ended || Input.GetMouseButtonUp(0))
        {
            ...
            {
                if (!eggFeature.GetComponent<PolygonCollider2D>().bounds.Contains(worldTouchPosition))
                {
                    eggFeature.SetActive(false);
                    EnableSonColliders(this.transform);
                }
                ...
                flagEggManage = !eggEgg6.activeSelf ? 2 : 0;
                flagEggManage = !eggEgg7.activeSelf ? 1 : 0; 
            }
