        ...
        if (Camera.main.transform.position.x == 60 && Camera.main.transform.position.y == 0)
        {
            ...
            if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Began || Input.GetMouseButtonDown(0))
            {
                ...
                if (!Camera.main.transform.Find("darkness").gameObject.activeSelf)
                {
                    ...
                    Debug.Log(flagPlace2 + " " + flagPlace3 + " " + flagPlace4 + " " + flagPlace6 + " " + flagPlace7 + " " + flagPlace8 + " " + flagPlace9 + " " + flagPlace10);
                    if ((flagPlace2 == 2 && flagPlace3 == 3 || flagPlace2 == 3 && flagPlace2 == 2) && flagPlace4 == 4 && flagPlace6 == 6 && flagPlace7 == 7 && flagPlace8 == 8 && flagPlace9 == 9 && flagPlace10 == 10)
                    {
